                    ...
                    function ($themeSwitch) {
                        $themeSwitch.addEventListener(
                            ...
                            function () {
                                ...
                                var newTheme =
                                    themes[(themes.indexOf(cfgTheme) + 1) % themes.length];
                                _this2.isDark =
                                    newTheme === 'dark' ||
                                    (newTheme === 'auto' &&
                                ...
                                (_window$localStorage = window.localStorage) === null ||
                                    ...
                                    _window$localStorage.setItem('theme', newTheme);
                                            ...
                                            .then(function (data) {
                                                ...
                                                _this3._index = lunr(function () {
                                                    ...
                                                    if (searchConfig.lunrLanguageCode)
                                                        this.use(
                                                            lunr[searchConfig.lunrLanguageCode]
                                                        );
                                                    this.ref('objectID');
                                                    this.field('title', {
                                                        boost: 50,
                                            ...
                                            requests: [
                                                {
                                                    ...
                                                    attributesToSnippet: [
                                                        'content:'.concat(snippetLength),
                                                    ],
                                                    highlightPreTag: '<'.concat(highlightTag, '>'),
                                                    highlightPostTag: '</'.concat(
                                                        highlightTag,
                                                        '>'
                                                    ),
                                                },
                    ...
                    function () {
                        ...
                        if ($mermaidElements.length) {
                            ...
                            Util.forEach($mermaidElements, function ($mermaid) {
                                mermaid
                                    .render('mermaid-svg-' + $mermaid.id, _this6.data[$mermaid.id])
                                    .then(function (_ref9) {
                                        var svg = _ref9.svg;
